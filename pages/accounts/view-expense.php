...
<div id="container">
    ...
    <div id="content-container">
        ...
        <div id="content-area">
			...
			<h3>Expense Accounts <a href="/accounts/view-expense/balances" class="button small">Show Balances</a> | <a href="/accounts/add/Expense" class="button small right">New</a></h3>
